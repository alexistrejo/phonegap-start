...
function iOSInit(){
    ...
    $(document).bind('onorientationchange',function(event){event.preventDefault();});
}
...
function initCharts(){
    ...
    window.seriesDeTiempo = new Highcharts.StockChart({
	chart : {
	    renderTo : 'graficaSeriesDeTiempo'
	}
	...
	,exporting :{
        ...
        window.grafica2 = new Highcharts.Chart({
            chart: {
                renderTo: 'containerGrafica2',
                zoomType: 'x',
                spacingRight: 20
            }	
	    ,credits:{enabled:false}
            ,title: {
                text: 'Grafica con zoom'
            },
            xAxis: {
                type: 'datetime',
